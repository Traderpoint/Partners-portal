...
export default function OrdersPage() {
  ...
  return (
    <>
      <Head>
        <title>Orders - Systrix Partners Portal</title>
        <meta name="description" content="Systrix Partners Portal - Orders" />
      </Head>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Manage and view all your affiliate orders and commissions
              </p>
            </div>
            ...
            <div className="card">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">
                  📋 Orders & Commissions ({filteredTotals.orders.length} orders)
                </h3>
