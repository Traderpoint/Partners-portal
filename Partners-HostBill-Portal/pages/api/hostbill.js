// EXACT COPY of working hostbill-test.js API endpoint
export default async function handler(req, res) {
  ...
  try {
    // HostBill API konfigurace - EXACT COPY from working affiliate-orders-test
    ...
    // Přidání dalších parametrů - EXACT COPY
    ...
    // Volání HostBill API pomocí fetch - EXACT COPY
