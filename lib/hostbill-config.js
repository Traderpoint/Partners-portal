// HostBill Configuration with Placeholders
// TO BE UPDATED: Replace placeholder IDs with real HostBill product/addon IDs
...
// Product IDs (FIXED - Using real HostBill product ID 5)
export const PRODUCTS = {
  VPS_BASIC: process.env.HOSTBILL_PRODUCT_VPS_BASIC || '5',
  VPS_PRO: process.env.HOSTBILL_PRODUCT_VPS_PRO || '5',
  VPS_ENTERPRISE: process.env.HOSTBILL_PRODUCT_VPS_ENTERPRISE || '5',
  VPS_PREMIUM: process.env.HOSTBILL_PRODUCT_VPS_PREMIUM || '5'
};
