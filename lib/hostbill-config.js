...
console.log('🔍 Product Mapping Debug:', {
  VPS_BASIC_MAPPING,
  VPS_PRO_MAPPING,
  VPS_ENTERPRISE_MAPPING,
  VPS_PREMIUM_MAPPING,
  env_values: {
    HOSTBILL_PRODUCT_VPS_BASIC: process.env.HOSTBILL_PRODUCT_VPS_BASIC,
    HOSTBILL_PRODUCT_VPS_PRO: process.env.HOSTBILL_PRODUCT_VPS_PRO,
    HOSTBILL_PRODUCT_VPS_ENTERPRISE: process.env.HOSTBILL_PRODUCT_VPS_ENTERPRISE,
    HOSTBILL_PRODUCT_VPS_PREMIUM: process.env.HOSTBILL_PRODUCT_VPS_PREMIUM
  }
});
